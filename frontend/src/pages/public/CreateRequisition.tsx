...
const CreateRequisition = () => {
  ...
  return (
    <div className="app-page-wide">
      {/* Header */}
      <div className="mb-8">
        <p className="app-kicker">Requisition Management</p>
      ...
      <form onSubmit={handleSubmit}>
          ...
          <div className="grid grid-cols-2">
            ...
            <div className="border-r-2 border-neutral-800 p-5">
              ...
              <input
                ...
                // required
                className="mt-2 w-full border-0 bg-transparent text-[12px] font-bold text-neutral-800 outline-none placeholder:text-neutral-500"
              />
              {errors.projectName && (
        ...
        <div className="mb-4 flex items-end justify-between">
          <div>
            <h2 className="text-[16px] font-bold text-neutral-900">Items</h2>
          ...
          <table className="w-full table-fixed border-collapse">
            <thead>
              <tr className="border-b-2 border-neutral-800">
                ...
                <th className="w-28 px-4 py-4 text-left text-[12px] font-bold uppercase text-neutral-500">
                  Qty
                </th>
                ...
                <th className="w-36 px-4 py-4 text-right text-[12px] font-bold uppercase text-neutral-500">
                  Rate
                </th>
                  ...
                  >
                    ...
                    <td className="px-4 py-3">
                      <input
                        ...
                        placeholder="0.00"
                        // required
                        className="app-input px-3 py-2 text-right"
                      />
            ...
            <tfoot>
              <tr className="border-t-2 border-neutral-800">
                ...
                <td
                  colSpan={2}
                  className="px-4 py-5 text-right text-[14px] font-bold text-[#281c59]"
                >
