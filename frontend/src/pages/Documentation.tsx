    ...
    <div className="app-page-wide py-5">
      ...
      <div className="flex flex-col items-center sm:flex-row sm:items-start sm:justify-center sm:divide-x sm:divide-neutral-500">
        <div className="py-2 sm:px-5 sm:py-0">
          <h3 className="mb-1 text-[14px] font-bold text-[#120078]">Backend</h3>
        ...
        <div className="py-2 sm:px-5 sm:py-0">
          <h3 className="mb-1 text-[14px] font-bold text-[#120078]">Frontend</h3>
          <ul className="space-y-0.5">
        ...
        <div className="py-2 sm:px-5 sm:py-0">
          <h3 className="mb-1 text-[14px] font-bold text-[#120078]">Authentication</h3>
          <ul className="space-y-0.5">
        ...
        <div className="py-2 sm:px-5 sm:py-0">
          <h3 className="mb-1 text-[14px] font-bold text-[#120078]">AI</h3>
          <ul className="space-y-0.5">
        ...
        <div className="py-2 sm:px-5 sm:py-0">
          <h3 className="mb-1 text-[14px] font-bold text-[#120078]">We're live with</h3>
          <ul className="space-y-0.5">
      ...
      <section className="mt-8">
        ...
        <div className="mx-auto mt-5 max-w-5xl text-neutral-500">
          <h3 className="mb-3 text-[15px] font-extrabold text-[#120078]">{workflow.title}</h3>
          ...
          <h4 className="mt-4 text-[12px] font-extrabold text-[#120078]">Stack</h4>
